...
import { __LOADER__COMMI } from "./secr-module";
...
document.addEventListener("DOMContentLoaded", async function () {
    ...
    navLinks.forEach(link => {
        link.addEventListener("click", function (e) {
            ...
            let newUrl = window.location.hash = `${tool}/secretary/${tool}`;
                window.location.hash =  `${tool}/secretary/${tool}`
    ...
    showToast(e || 'Unexpected error', 'error')
  }
